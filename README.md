...
[ ![](https://img.shields.io/github/actions/workflow/status/BitBagCommerce/SyliusBraintreePlugin/build.yml) ](https://github.com/BitBagCommerce/SyliusBraintreePlugin/actions "Build status")
